...
@property (nonatomic, assign) YQEditSelectImageViewShapeStyle style;
...
- (void)drawShapeContext:(CGContextRef)context
{
    if (self.width || self.height) {
        ...
        if (self.style == YQEditSelectImageViewShapeStyle_rect) {
            CGContextAddRect(context, rect);
        }else if (self.style == YQEditSelectImageViewShapeStyle_circle){
